<template>
    <div class="task__detail mt-3">
        <div class="task__detail-header d-flex flex-row mt-3">
            ...
            <div class="detail-header__title ml-2" style="color: #fff">Task Detail</div>
        </div>
        <div class="task__detail-center mt-5">
            <div class="detail-center__header d-flex flex-row align-items-center">
                ...
                <div class="detail-center__title" style="color: #fff">{{ taskDetail.nameTask }}</div>
            </div>
            <div class="detail-center__main">
                <div class="d-flex flex-column mt-3">
                    <div class="center__main-label" style="color: #bbb">Due Date</div>
                    <div class="center__main-info" style="color: #ccc">{{ taskDetail.deadline }}</div>
                </div>
                <div class="d-flex flex-column mt-3">
                    <div class="center__main-label" style="color: #bbb">Description</div>
                    <div class="center__main-info" style="color: #ccc">
                        {{ taskDetail.description }}
                    </div>
                </div>
                <div class="d-flex flex-column mt-3">
                    <div class="center__main-label" style="color: #bbb">Subtask</div>
                    <div class="center__main-info" style="color: #ccc">
